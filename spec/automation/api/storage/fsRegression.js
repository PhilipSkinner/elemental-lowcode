...
const noResultsTest = () => {
    return chakram.get('http://localhost:8006/fsrecordings', {
        headers : {
...
const addRecordingTest = () => {
    return chakram.post('http://localhost:8006/fsrecordings', {
        name : 'Test recording',
        length : 1234
    }, {
        headers : {
...
const getCountTest = () => {
    return chakram.get('http://localhost:8006/fsrecordings/.details', {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const getRecordingTest = () => {
    return chakram.get(`http://localhost:8006/fsrecordings/${id}`, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const getNotFound = () => {
    return chakram.get('http://localhost:8006/fsrecordings/dfkjsdfksdf', {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const updateRecordingTest = () => {
    return chakram.put(`http://localhost:8006/fsrecordings/${id}`, {
...
const updateNotFoundTest = () => {
    return chakram.put('http://localhost:8006/fsrecordings/sadadasd', {
        name : 'Updated test recording',
        length : 2345
    }, {
        headers : {
...
const patchRecordingTest = () => {
    return chakram.patch(`http://localhost:8006/fsrecordings/${id}`, {
        length : 3456
    }, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
...
const patchNotFoundTest = () => {
    return chakram.patch('http://localhost:8006/fsrecordings/sdfsfdds', {
        length : 3456
    }, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
...
const deleteRecordingTest = () => {
    return chakram.delete(`http://localhost:8006/fsrecordings/${id}`, {}, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const singleObjectNotDefinedTest = () => {
    return chakram.get(`http://localhost:8006/fsrecordings/${id}/work`, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const notFoundSingleObject = () => {
    return chakram.get('http://localhost:8006/fsrecordings/asdad/work', {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const updateSingleObject = () => {
    return chakram.put(`http://localhost:8006/fsrecordings/${id}/work`, {
...
const updateSingleNotFound = () => {
    return chakram.put('http://localhost:8006/fsrecordings/asdadsad/work', {
        name : 'work object name'
    }, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
...
const patchSingleObject = () => {
    return chakram.patch(`http://localhost:8006/fsrecordings/${id}/work`, {
...
const patchSingleNotFoundTest = () => {
    return chakram.patch('http://localhost:8006/fsrecordings/sdfsfdsf/work', {
        name : 'patched work object name'
    }, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
...
const dualSingleObjectNotDefinedTest = () => {
    return chakram.get(`http://localhost:8006/fsrecordings/${id}/work/composer`, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const notFoundDualObject = () => {
    return chakram.get('http://localhost:8006/fsrecordings/eefsfsef/work/composer', {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const updateDualSingleObject = () => {
    return chakram.put(`http://localhost:8006/fsrecordings/${id}/work/composer`, {
        name : 'test composer',
        functions : [
            'one',
            'two'
...
const updateDualNotFound = () => {
    return chakram.put('http://localhost:8006/fsrecordings/sdfsdfsfd/work/composer', {
        name : 'test composer',
        functions : [
            'one',
            'two'
...
const patchDualSingleObject = () => {
    return chakram.patch(`http://localhost:8006/fsrecordings/${id}/work/composer`, {
        functions : [
            'one'
        ]
    }, {
...
const patchDualNotFound = () => {
    return chakram.patch('http://localhost:8006/fsrecordings/ssdfsdf/work/composer', {
        functions : [
            'one'
        ]
    }, {
...
const multiObjectListNoResults = () => {
    return chakram.get(`http://localhost:8006/fsrecordings/${id}/recording_artists`, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const multiObjectListAdd = () => {
    return chakram.post(`http://localhost:8006/fsrecordings/${id}/recording_artists`, {
        name : 'test artist',
        functions : [
            'one',
            'two'
...
const multiObjectListAddNotFound = () => {
    return chakram.post('http://localhost:8006/fsrecordings/sdfsfd/recording_artists', {
        name : 'test artist',
        functions : [
            'one',
            'two'
...
const multiObjectListNotFound = () => {
    return chakram.get('http://localhost:8006/fsrecordings/asdsad/recording_artists', {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const multiObjectCount = () => {
    return chakram.get(`http://localhost:8006/fsrecordings/${id}/recording_artists/.details`, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const multiObjectCountRestricts = () => {
    return chakram.post('http://localhost:8006/fsrecordings', {
        ...
        return chakram.post(`http://localhost:8006/fsrecordings/${newId}/recording_artists`, {
            name : 'test artist',
            functions : [
                'one',
                'two'
...
const multiObjectCountNotFound = () => {
    return chakram.get('http://localhost:8006/fsrecordings/asdadasd/recording_artists/.details', {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const multiObjectListGet = () => {
    return chakram.get(`http://localhost:8006/fsrecordings/${id}/recording_artists/${childId}`, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const multiObjectNotFound = () => {
    return chakram.get(`http://localhost:8006/fsrecordings/${id}/recording_artists/asdadsa`, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const multiObjectListUpdate = () => {
    return chakram.put(`http://localhost:8006/fsrecordings/${id}/recording_artists/${childId}`, {
...
const multiObjectListUpdateNotFound = () => {
    return chakram.put(`http://localhost:8006/fsrecordings/${id}/recording_artists/asdadad`, {
        name : 'updated test artist',
        functions : [
            'one',
            'two',
...
const multiObjectListPatch = () => {
    return chakram.patch(`http://localhost:8006/fsrecordings/${id}/recording_artists/${childId}`, {
        functions : [
            'one'
        ]
    }, {
...
const multiObjectListDelete = () => {
    return chakram.delete(`http://localhost:8006/fsrecordings/${id}/recording_artists/${childId}`, {}, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
const multiObjectListDeleteNotFound = () => {
    return chakram.delete(`http://localhost:8006/fsrecordings/${id}/recording_artists/sdfsdf`, {}, {
        headers : {
            Authorization : `Bearer ${helpers.getToken()}`
        }
    }).then((response) => {
...
/* test cases */
describe('A filesystem backed storage API', function () {
    describe('root layer', () => {
